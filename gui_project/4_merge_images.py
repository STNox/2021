...
def add_file():
    files = filedialog.askopenfilenames(
        ...
        initialdir=r'C:\Users\caush\Desktop\C\python\2021Python' # 최초 경로를 보여줌
        )
...
# 선택 삭제
def del_file():
    for index in reversed(list_file.curselection()): # reversed: 원본 데이터를 변경하지 않음
...
def merge_image():
    ...
    dest_path = os.path.join(txt_dest_path.get(), 'result_photo.jpg')
